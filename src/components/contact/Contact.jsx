            ...
            <div className="contact__content">
                ...
                <div className='contact__info'>
                    ...
                    <div className='contact__card'>
                        ...
                        <span className='contact__card-data'>832 922 3801</span>

                        <a href='https://api.whatsapp.com/send?phone=62214408789&text=Hello , more in formation !' className='contact__button'>Write me {" "}
                        <i className='bx bx-right-arrow-alt contact__button-icon'></i></a>
                    </div>
